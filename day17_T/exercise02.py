...
#             return item
#
# print(find_single(condition04).__dict__)
...
for item in IterableHelper.select(list_wifes,lambda item:(item.name,item.face_score)):
    print(item)
print("---------------------------")
for item in IterableHelper.select(list_wifes, lambda item:(item.name,item.face_score,item.height)):
    print(item)

# 练习5：
#       需求1：在老婆列表中查找颜值最高的老婆
#       需求2：在老婆列表中查找财产最大的老婆
# print(IterableHelper.find_single_face(list_wifes,lambda item,max:item.face_score>max))

print("-----------------------")
IterableHelper.get_sort(list_wifes, lambda w: w.height)
for i in list_wifes:
    print(i.__dict__)


print("-----------------------")
IterableHelper.get_sort(list_wifes, lambda w: w.weight)
for i in list_wifes:
    print(i.__dict__)

print(IterableHelper.add(list_wifes, lambda w: w.weight))
print(IterableHelper.add(list_wifes, lambda w: w.money))
